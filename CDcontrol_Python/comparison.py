...
data_1x = get_data_from_txt(r"Outputs\20260910\225_Helicoids_dilution\1x\1x.csv")
data_5x = get_data_from_txt(r"Outputs\20260910\225_Helicoids_dilution\5x\5x.csv")
data_25x = get_data_from_txt(r"Outputs\20260910\225_Helicoids_dilution\25xbis\25xbis.csv")
data_125x = get_data_from_txt(r"Outputs\20260910\225_Helicoids_dilution\125x\125x.csv")
