...
class ControlPanel(tk.Tk):
    def __init__(self):
        ...
        # ------------------------------------------------------------------
        # Motor Control  (position entry on top, actions below it)
        # ------------------------------------------------------------------
        ...
        self.move_position_label = tk.Label(self.motor_control_panel, text="Position (deg):")
        ...
        self.home_motor_button = tk.Button(self.motor_control_panel, text="Home Motor", command=self.home_motor_click)
        ...
        # ------------------------------------------------------------------
        # Spectrometer Control, split into Settings / Actions / Save
        # ------------------------------------------------------------------
        ...
        # -- Settings sub-panel: integration time + time average + Set button --
        ...
        self.set_int_time_btn = tk.Button(self.settings_panel, text="Set", command=self.set_settings_click)
        self.set_int_time_btn.grid(row=0, column=3, rowspan=2, padx=8, pady=5, sticky="ns")

        self.set_settings_click()  # Set initial settings

        # -- Actions sub-panel: things that trigger a measurement --
        ...
        self.baseline_btn = tk.Button(self.actions_panel, text="Measure Baseline", command=self.spec.measure_baseline)
        ...
        self.show_max_btn.grid(row=1, column=0, padx=8, pady=5, sticky="ew")

        self.live_view_btn = tk.Button(self.actions_panel, text="Start Live View", command=self.toggle_live_view)
        self.live_view_btn.grid(row=1, column=1, padx=8, pady=5, sticky="ew")

        # -- Save sub-panel: filename + save actions --
        self.save_panel = tk.LabelFrame(self.spectrometer_panel, text="Save")
        self.save_panel.grid(row=2, column=0, padx=8, pady=(4, 8), sticky="ew")
